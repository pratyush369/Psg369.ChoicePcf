...
import { IOptionsetCheckboxProps, OptionsetCheckbox } from "./OptionsetControl";
...
export class Optionset implements ComponentFramework.StandardControl<IInputs, IOutputs> {
  ...
  public updateView(context: ComponentFramework.Context<IInputs>): void {
    this.contextObj = context;
    ReactDOM.render(
      React.createElement(OptionsetCheckbox, {
        ...
        isMasked: !this.contextObj.parameters.OptionsetColumn.security?.readable,
        isDisabled: this.contextObj.mode.isControlDisabled || !this.contextObj.parameters.OptionsetColumn.security?.editable,
